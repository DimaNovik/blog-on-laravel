        ...
        <b-col>
            ...
            >
                ...
                <template v-slot:cell(type)="row">
                    ...
                    <span v-if="row.item.type == 1" class="table-icon" title="Сплачено">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 492 492"><path fill="#3caea3"
                                                                                            stroke="#3caea3"
                                                                                            d="M419.9 72.1C373.4 25.7 311.7 0 246 0S118.5 25.6 72.1 72.1C25.6 118.5 0 180.3 0 246s25.6 127.5 72.1 173.9C118.5 466.4 180.3 492 246 492s127.5-25.6 173.9-72.1C466.3 373.4 492 311.7 492 246s-25.6-127.5-72.1-173.9zM246 456c-115.8 0-210-94.2-210-210S130.2 36 246 36s210 94.2 210 210-94.2 210-210 210z"/><path
                                fill="#3caea3"
                                d="M373.6 183.4l-43.5-43.8c-7-7-18.4-7.1-25.5-.1L243 200.8c-7 7-7.1 18.4-.1 25.5 7 7 18.4 7.1 25.5.1l48.8-48.6 18.2 18.3-118.7 118.1-60.3-60.6 18.3-18.2 29.3 29.5c7 7 18.4 7.1 25.5.1 7-7 7.1-18.4.1-25.5l-42-42.3c-3.4-3.4-7.9-5.3-12.7-5.3h-.1c-4.8 0-9.3 1.9-12.7 5.2l-43.9 43.6c-3.4 3.4-5.3 7.9-5.3 12.7 0 4.8 1.9 9.4 5.2 12.7l85.6 86.1c3.4 3.4 7.9 5.3 12.7 5.3h.1c4.8 0 9.3-1.9 12.7-5.2l144.3-143.5c3.4-3.4 5.3-7.9 5.3-12.7 0-4.8-1.9-9.4-5.2-12.7z"/></svg>
                    </span>
                        ...
                        <b-link href="#"
                                ...
                                target="_blank"
                                title="Інформація"
                                @click.prevent="showDetails(row.item)">
                        ...
                        <b-link href="#"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 486.4 486.4" class="table-icon">
                                <path fill="#ed553b"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions('Orders', ['deleteOrder', 'getGroupScore']),
            ...
            showDetails(record, index) {
                ...
                this.getOnceAction(record.action_id).then(() => {
                    ...
                    services.forEach(item => {
                        this.getOnceService({id: item.service, count: item.count}).finally(()=> {
            ...
            openEdit(data) {
                ...
                this.editOrderInfo = {
                    id: data.item.id,
                    create: data.item.created_at,
                    fio: data.item.fio,
                    invoice: data.item.invoice,
                    pay_date: data.item.pay_date,
                    action_date: data.item.action_date,
                };
            },
        },
        created() {
